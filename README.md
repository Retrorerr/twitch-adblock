...
```text
https://raw.githubusercontent.com/Retrorerr/twitch-adblock/main/dist/vaft-ublock-origin.js?v=0.1.1
```

The `?v=0.1.1` part helps uBlock Origin fetch the current version instead of using an older cached copy.
